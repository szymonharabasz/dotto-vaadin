...
public class DottosService {
    ...
    public DottosService() {
        dottos = new ArrayList<>();
        dottos.add(new Dotto(
    ...
    public void createDotto(DottoInput dottoInput) {
        dottos.add(new Dotto(
                dottoInput.getTitle(),
                dottoInput.getDescription(),
                LocalDateTime.now(),
                dottoInput.getRating()
        ));
    }
}
